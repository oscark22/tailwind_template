        ...
        <div class="flex basis-1/2">
          <nav class="mx-auto">
            <ul class="flex text-white space-x-6">
              ...
              <li>
                <a class="btn-primary px-5 py-2" href="https://tailwindcss.com/docs/installation">Pricing</a> 
              </li>
              <li>
        ...
        <div class="flex basis-1/4">
          <nav class="ml-auto">
            <ul class="flex space-x-3">
              ...
              <li>
                <a class="text-gray-500 hover:text-gray-800" href="https://icons.getbootstrap.com/icons/facebook/">
                  <svg class="w-7 h-7" fill="currentColor" viewBox="0 0 16 16">
